            ...
            <div class="about-sub-inner text-center mt-lg-4 mt-3">
               ...
               <div class="row">
                  <div class="col-lg-4 col-md-4 abut-gride">
                     ...
                     <h5>Shipping</h5>
                     <p class="mt-3"> Fast, Reliable, and Secure Shipping,
                        Safely Delivering Your Artworks Worldwide.
                     </p>
                  </div>
                  <div class="col-lg-4 col-md-4 abut-gride">
                     <span class="fas fa-phone-volume"></span>  
                     <h5>Support</h5>
                     <p class="mt-3"> Expert Support-Ensuring a Seamless 
                        Art Experience from Gallery to Home.
                     </p>
                  </div>
                  <div class="col-lg-4 col-md-4 abut-gride">
                     <span class="fas fa-undo"></span>
                     <h5> Return</h5>
                     <p class="mt-3"> Easy Returns - Return Your Artwork Stress-Free 
